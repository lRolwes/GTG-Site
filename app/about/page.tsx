  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#CBBEA4]">
      ...
      <main className="flex-grow">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-700">
                At our travel agency, we&apos;re dedicated to crafting unforgettable journeys that inspire, delight, and broaden horizons. Our mission is to transform your travel dreams into reality, providing personalized experiences that create lasting memories.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 sm:py-16 lg:py-20 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl sm:text-4xl font-bold text-primary mb-10 text-center">Why Choose Us</h2>
        ...
        <section className="py-12 sm:py-16 lg:py-20 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl sm:text-4xl font-bold text-primary mb-10 text-center">Meet Our Team</h2>
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">    
        ...
        <section className="py-12 sm:py-16 lg:py-20 bg-[#E8791D]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-white mb-8 max-w-2xl mx-auto">
              Let us help you turn your travel dreams into unforgettable experiences. Contact us today to start planning your next adventure.
            </p>
            <Link 
              href="/contact" 
